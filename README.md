...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    	...
    	Lcd_cursor(&lcd,0,1);
   Lcd_string(&lcd, "PRIYA VARSHINI P");
   Lcd_cursor(&lcd,1,1);
   Lcd_string(&lcd, "212224240119");
...
<img width="1920" height="1200" alt="image" src="https://github.com/user-attachments/assets/e1ab38ff-b9a9-460d-b798-ef1aa9f5b965" />

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 <img width="1005" height="828" alt="image" src="https://github.com/user-attachments/assets/47acacff-003d-4613-9b30-724bb60bcac3" />
